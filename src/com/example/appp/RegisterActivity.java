...
public class RegisterActivity extends Activity implements OnClickListener {
	...
	public void onClick( View v )
	{
		...
		switch ( v.getId() )
		{
			...
			case R.id.btnRegister :
				...
				// show this values on LogCat to see it that these values are
				// there

				Log.e("Values to Retister", strName + ", " + strEmail + ", " + strPhone + ", " + strPass + ", "
						+ strPass2);
				...
				// /// IF THE CODE IS EXECUTE AT THIS POINT MEANS THAT EVERY
				// VALIDATION PASS /////
				else
				{

					// Execute the method Register to complete the
					// registrations\
	...
	public void alertDialog( String Message )
	{
		...
		new AlertDialog.Builder(this).setTitle("TaxiCab Message").setMessage(Message)
	...
	protected void RegisterHttpJson( final String Username, final String Email, final String Phone,
	...
	public void respond( int callBack )
	{
		...
		if( callBack == 1 )
		{
			...
			new AlertDialog.Builder(this).setTitle("TaxiCab Message")
